...
const args = {
  ...
  option2: "Go to the right of the space station.",
  handlebarsName: "space_station",
  option1Function: function(req, locals){
    locals.textEventParagraph = "You hail the space station. It has been commandeered by pirates! They race to intercept you. You are boarded and lose 1 crew member."
    locals.crew -= 1
    req.session.crew -= 1
  },
